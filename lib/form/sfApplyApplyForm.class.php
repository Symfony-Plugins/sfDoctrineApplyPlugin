      ...
      new sfValidatorAnd(
        array(
          ...
          new sfValidatorDoctrineUnique(array('model' => 'sfGuardUser',
            'column' => 'username'), array("invalid" => "There is already a user by that name. Choose another.")))));
      ...
      new sfValidatorAnd(
        array(
          ...
          new sfValidatorDoctrineUnique(array('model' => 'sfGuardUserProfile',
            'column' => 'email'), array("invalid" => "An account with that email address already exists. If you have forgotten your password, click \"cancel\", then \"Reset My Password.\"")))));
